...
import { DOCX_MAX_SCALE, DOCX_MIN_SCALE } from "./utils";

export type DocxViewerToolbarProps = {
  page: number;
  numPages: number;
  scale: number;
  onPrev: () => void;
...
/** Панель навигации `DocxViewer`: скролл к предыдущей/следующей странице, клик по счётчику для перехода на конкретную, зум */
